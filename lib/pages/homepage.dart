...
import 'package:music_mania/model/radio.dart';
import 'package:music_mania/utils/ai_util.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan(){
    AlanVoice.addButton(
        "13188070aa0d989f61e1d8b29c8ce96d2e956eca572e1d8b807a3e2338fdd0dc/stage",
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            "Start with - Hey Alan ".text.italic.white.make(),
                ...
                return VxBox(
                  ...
                  [
                    Positioned(
                      ...
                      ).height(40).black.alignCenter.make(),
                    ),
                    Align(
                    ...
                    .border(color: Colors.black, width: 6)
